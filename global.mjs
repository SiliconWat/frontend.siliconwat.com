import { THONLY, AUTH, FRONTEND_COURSE, CAMPUS, TRILOGY, HOME, DEVICE } from "https://thonly.org/global.mjs";
export { THONLY, AUTH, FRONTEND_COURSE as ORIGIN, CAMPUS, TRILOGY, HOME, DEVICE };
