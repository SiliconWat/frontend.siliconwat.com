...
template.innerHTML = `
    ...
    <section id="course">
        ...
        <p><strong>Top graduates</strong> will have the opportunity to <em>tutor</em> <strong>new students</strong> to gain more experience and more <strong>SW Coins</strong>!</p>
        <p>Afterwards, <strong>top tutors</strong> will have the opportunity to interview for a <em>paid consultancy</em> at my <a href="https://siliconwat.dev">Silicon Wat Agency</a>!</p>
    </section>
    <section id="cohort">
        <table>
