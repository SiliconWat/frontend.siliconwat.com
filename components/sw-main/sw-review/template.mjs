...
template.innerHTML = `
    ...
    <link rel="stylesheet" href="${FRONTEND}/components/sw-main/sw-review/shadow.css">
    <main>
        <header>
            <h1></h1>
            <br>
        ...
        <section class="summary">
            ...
            <p>Additionally, to <em>graduate</em> from the <strong>Cohort Program</strong>, your classmates need to give your <strong>Medium Summaries</strong> a <em>passing grade</em>.</p>
