...
template.innerHTML = `
    ...
    <main>
        ...
        <section>
            ...
            <figure>📖</figure>
            <ul>
                <li class="special">If you purchase my <a id="udemy">Udemy Course</a>, you can watch my <strong>Lecture Videos</strong> with <em>subtitles</em> at 7 different <em>speeds</em> (from &half; to 2x).</li>
                <li class="special">You can read my corresponding <a class="medium">Textbook Chapters</a> with <em>helpful diagrams</em> and <strong>side notes</strong> on Medium for FREE.</li>
                <li class="coin">You can take my corresponding <a id="quiz">Quizzes</a> for FREE to check your <em>understanding</em> and earn <strong>SW Coins</strong>!</li>
        ...
        <section>
            ...
            <figure>💻</figure>
            <ul>
                <li class="coin">You can play my <em>interactive</em> <a id="code">Code Exercises</a> for FREE to test your <em>coding skills</em> and earn <strong>SW Coins</strong>!</li>
        ...
        <section>
            ...
            <figure>👩🏼‍💻</figure>
            <ul>
                <li class="coin">You can play my <a id="flashcard">Flashcard Games</a> for FREE to remember <em>code syntaxes</em> and earn <strong>SW Coins</strong>!</li>
