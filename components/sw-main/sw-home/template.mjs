    ...
    <main>
        ...
        <section>
            ...
            <ul>
                ...
                <li>If you join my <a class="cohort"></a>, you can form <strong>Study Groups</strong> with your <em>classmates</em> on Discord.</li>
            </ul>
        </section>
        <section>
            <h2>Practice</h2>
            ...
            <ul>
                ...
                <li>If you join my <a class="cohort"></a>, you can <strong>Pair Program</strong> with your <em>classmates</em> on Discord.</li>
                <li>If you join my <a class="cohort"></a>, you can submit your <strong>Codepen Project</strong> for <em>grading</em> and <em>ranking</em> by your classmates.</li>
            </ul>
        </section>
        <section>
            <h2>Review</h2>
            ...
            <ul>
                ...
                <li>If you join my <a class="cohort"></a>, you can submit your <strong>Medium Summaries</strong> for <em>grading</em> and <em>comments</em> by your classmates.</li>
